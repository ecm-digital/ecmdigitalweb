...
export default function ForWhomSection() {
  ...
  return (
    <section id="for-whom" className="section section-polish relative reveal-on-scroll" style={{ borderTop: '1px solid rgba(255,255,255,0.05)', backgroundColor: 'var(--surface-1)' }}>
      ...
      <div className="container relative z-10">
        <div className="section-header text-center fade-in-up" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: '60px' }}>
          <span className="section-label" style={{ padding: '8px 16px', background: 'rgba(99, 102, 241, 0.1)', color: '#818cf8', borderRadius: '999px', border: '1px solid rgba(99, 102, 241, 0.2)' }}>
            {T('forwhom.label') || "Dla Kogo Pracujemy"}
          </span>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 280px), 1fr))', gap: '32px' }}>
          ...
          <div className="premium-glass-panel premium-hover-lift fade-in-left" style={{ padding: 'clamp(24px, 5vw, 48px)', borderRadius: '20px', border: '1px solid rgba(99, 102, 241, 0.08)', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            ...
            <div style={{ marginTop: '40px' }}>
              <a href="#contact" className="btn-secondary" style={{ display: 'block', width: '100%', textAlign: 'center' }}>
                {T('hero.cta2')}
              </a>
            </div>
          </div>
          ...
          <div className="premium-glass-panel premium-hover-lift fade-in-right" style={{ padding: 'clamp(24px, 5vw, 48px)', borderRadius: '20px', border: '1px solid rgba(59, 130, 246, 0.08)', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            <div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '24px' }}>
