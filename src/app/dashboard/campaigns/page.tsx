            ...
            <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-1000">
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                    <div>
                        ...
                        <p className="text-sm text-white/30 font-black uppercase tracking-[0.2em] mt-2">Monitoruj wyniki działań marketingowych w czasie rzeczywistym</p>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
                    <div className="bg-white/[0.04] backdrop-blur-xl border border-white/10 rounded-[40px] p-10 relative overflow-hidden group shadow-2xl">
                        ...
                        <span className="text-xs text-white/20 uppercase tracking-[0.2em] font-black block mb-6 italic">Aktywny Budżet</span>
                        ...
                        <div className="mt-6 flex items-center gap-3">
                            ...
                            <span className="text-xs text-white/30 font-black uppercase tracking-widest">Zakumulowany kapitał</span>
                        </div>
                    </div>
                    <div className="bg-white/[0.04] backdrop-blur-xl border border-white/10 rounded-[40px] p-10 relative overflow-hidden group shadow-2xl">
                        ...
                        <span className="text-xs text-white/20 uppercase tracking-[0.2em] font-black block mb-6 italic">Realne Wydatki</span>
                        ...
                        <div className="mt-6 flex items-center gap-3">
                            ...
                            <span className="text-xs text-white/30 font-black uppercase tracking-widest">Koszty mediowe netto</span>
                        </div>
                    </div>
                    <div className="bg-white/[0.04] backdrop-blur-xl border border-white/10 rounded-[40px] p-10 relative overflow-hidden group shadow-2xl">
                        ...
                        <span className="text-xs text-white/20 uppercase tracking-[0.2em] font-black block mb-6 italic">Wynik: Konwersje</span>
                        ...
                        <div className="mt-6 flex items-center gap-3">
                            ...
                            <span className="text-xs text-white/30 font-black uppercase tracking-widest">Leady / Sprzedaż / Akcje</span>
                        </div>
                    </div>
                </div>
                ...
                {loading ? (
                    ...
                    <div className="py-32 bg-white/[0.04] backdrop-blur-xl border border-white/10 border-dashed rounded-[48px] text-center group">
                        ...
                        <p className="text-white/30 text-base max-w-md mx-auto px-6 font-medium">Obecnie nie prowadzimy żadnych aktywnych kampanii reklamowych dla Twojej marki.</p>
                            ...
                            return (
                                <div key={c.id} className="bg-white/[0.04] backdrop-blur-xl border border-white/10 rounded-[48px] p-10 flex flex-col hover:bg-white/[0.05] transition-all group relative overflow-hidden shadow-2xl">
                                    ...
                                    <div className="flex justify-between items-start mb-10 relative z-10">
                                        ...
                                        <span className={`text-xs px-3 py-1.5 rounded-full font-black uppercase tracking-widest border transition-colors ${statusColors[c.status] || ''}`}>
                                            {c.status}
                                        </span>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-3 gap-6 p-8 bg-black/40 rounded-[32px] border border-white/5 mb-10 relative z-10 shadow-inner">
                                        <div className="text-center">
                                            ...
                                            <div className="text-xs text-white/20 font-black uppercase tracking-widest mt-2 px-1">Kliknięcia</div>
                                        </div>
                                        <div className="text-center border-x border-white/5">
                                            <div className="text-2xl font-black font-space-grotesk italic text-emerald-400">{c.conversions}</div>
                                            <div className="text-xs text-white/20 font-black uppercase tracking-widest mt-2 px-1">Konwersje</div>
                                        </div>
                                        <div className="text-center">
                                            ...
                                            <div className="text-xs text-white/20 font-black uppercase tracking-widest mt-2 px-1">Koszt CPA</div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center justify-between mt-auto pt-8 border-t border-white/5 relative z-10">
                                        <div className="flex flex-col">
                                            <span className="text-xs text-white/20 font-black uppercase tracking-widest italic">Okres Działań</span>
